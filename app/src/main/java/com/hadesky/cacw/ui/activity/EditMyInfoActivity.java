...
public class EditMyInfoActivity extends BaseActivity implements View.OnClickListener, PopupMenu.OnMenuItemClickListener, EditMyInfoView
{
    ...
    private TextView mNickNameTextView, mSexTextView, mSummaryTextView, mUserNameTextView, mPhoneTextView, mShortPhone, mAddressTextView;
    ...
    private void showAddressDialog()
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle(getString(R.string.address)).setView(view).setPositiveButton(getString(android.R.string.ok), new DialogInterface.OnClickListener()
        {
            @Override
    ...
    private void showEditPhoneDialog()
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle(getString(R.string.phone_number)).setView(view).setPositiveButton(getString(android.R.string.ok), new DialogInterface.OnClickListener()
        {
            @Override
            public void onClick(DialogInterface dialog, int which)
            {
    ...
    private void showSummaryDialog()
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle(getString(R.string.personal_summary)).setView(view).setPositiveButton(getString(android.R.string.ok), new DialogInterface.OnClickListener()
        {
            @Override
            public void onClick(DialogInterface dialog, int which)
            {
    ...
    private void showNickNameDialog()
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle(getString(R.string.edit_nick_name)).setView(view).setPositiveButton(getString(android.R.string.ok), new DialogInterface.OnClickListener()
        {
            @Override
            public void onClick(DialogInterface dialog, int which)
            {
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setItems(new CharSequence[]{"拍照", "从图库中选择"}, new DialogInterface.OnClickListener()
        {
            @Override
            public void onClick(DialogInterface dialog, int which)
            {
            ...
            case AFTER_CROP:
                if (resultCode == RESULT_OK)
                {
                    if (data != null && data.getData() != null)
                    {
                        ...
                        File result = ImageResizer.getCompressBitmap(filePath.getPath(), getTempFileName(TEMP_FILE_NAME_LOW), this);
                        if (result != null)
                        {
                            mPresenter.updateAvatar(result);
                        } else
                        {
    ...
    public void setSex(int sex)
    {
        ...
        if (sex == UserBean.SEX_MALE)
        {
            mSexTextView.setText("男");
        } else if (sex == UserBean.SEX_FEMALE)
        {
