...
/**
 *  图片压缩算法
 *  来自https://github.com/Curzibn/Luban/blob/master/library/src/main/java/top/zibin/luban/Luban.java
 */
public class Luban {
    ...
    private static class innerclass{
        public static Luban sLuban = new Luban();
    }

    public static Luban getInstance()
    {
        return innerclass.sLuban;
    }
    ...
    public File thirdCompress(@NonNull File file,String thumb) {
        ...
        int thumbW = width % 2 == 1 ? width + 1 : width; //如果是奇数，+1转为偶数
        int thumbH = height % 2 == 1 ? height + 1 : height;

        width = thumbW > thumbH ? thumbH : thumbW; //取最小
        height = thumbW > thumbH ? thumbW : thumbH;//取最大
    ...
    public File firstCompress(@NonNull File file,String thumbFilePath) {
        int minSize = 60;
        int longSide = 720;
        int shortSide = 1280;
